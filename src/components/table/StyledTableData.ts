...
const baseStyles = tw`font-sans text-dark-300 text-base px-4 py-2 align-middle border-solid border-t-0 border-b-0 border-l-0 border-r border-light-300 last:border-r-0`
